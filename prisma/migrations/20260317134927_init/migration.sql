...
-- CreateEnum
CREATE TYPE "HuntMode" AS ENUM ('COMMUNITY', 'PARTNER');
...
CREATE TABLE "Hunt" (
    ...
    "mode" "HuntMode" NOT NULL DEFAULT 'COMMUNITY',
    "partnerId" TEXT,
...
-- AddForeignKey
ALTER TABLE "Hunt" ADD CONSTRAINT "Hunt_partnerId_fkey" FOREIGN KEY ("partnerId") REFERENCES "Partner"("id") ON DELETE SET NULL ON UPDATE CASCADE;
